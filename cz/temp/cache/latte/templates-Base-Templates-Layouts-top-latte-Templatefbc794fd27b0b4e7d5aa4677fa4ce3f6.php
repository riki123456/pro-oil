<?php
// source: D:\!__robota\00__PHP\pro-oil.cz\App\Modules\Admin/templates/../../Base/Templates/Layouts/top.latte

class Templatefbc794fd27b0b4e7d5aa4677fa4ce3f6 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('c65667c632', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block stylesFiles
//
if (!function_exists($_b->blocks['stylesFiles'][] = '_lb341defafbf_stylesFiles')) { function _lb341defafbf_stylesFiles($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block styles
//
if (!function_exists($_b->blocks['styles'][] = '_lbf436b744b8_styles')) { function _lbf436b744b8_styles($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
