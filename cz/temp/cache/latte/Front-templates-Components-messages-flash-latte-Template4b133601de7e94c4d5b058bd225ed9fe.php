<?php
// source: /home/riki/work/www/pro-oil/App/Modules/Front/templates/Components/messages-flash.latte

class Template4b133601de7e94c4d5b058bd225ed9fe extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('dccfd9d771', 'html')
;
