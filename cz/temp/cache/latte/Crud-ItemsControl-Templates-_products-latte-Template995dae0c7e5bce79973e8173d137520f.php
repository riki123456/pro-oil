<?php
// source: D:\!__robota\00__PHP\pro-oil.cz\App\Components\Controls\Crud\ItemsControl/Templates/_products.latte

class Template995dae0c7e5bce79973e8173d137520f extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('f2df985b88', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block _productsContainer
//
if (!function_exists($_b->blocks['_productsContainer'][] = '_lb8c1d788aee__productsContainer')) { function _lb8c1d788aee__productsContainer($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('productsContainer', FALSE)
