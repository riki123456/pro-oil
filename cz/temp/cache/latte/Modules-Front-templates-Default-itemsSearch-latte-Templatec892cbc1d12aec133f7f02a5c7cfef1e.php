<?php
// source: D:\!__robota\00__PHP\pro-oil.cz\App\Modules\Front/templates/Default/itemsSearch.latte

class Templatec892cbc1d12aec133f7f02a5c7cfef1e extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('e6da66a630', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block rightbar
//
if (!function_exists($_b->blocks['rightbar'][] = '_lb94a7d100bd_rightbar')) { function _lb94a7d100bd_rightbar($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb58e10a23e2_content')) { function _lb58e10a23e2_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
