<?php
// source: D:\!__robota\00__PHP\pro-oil.cz\App\Modules\Front/templates/../../Base/Templates/Layouts/top.latte

class Template35b305d73ceb73e935e3b7e66f8e35f5 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('2f1a35acd5', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block stylesFiles
//
if (!function_exists($_b->blocks['stylesFiles'][] = '_lb0e6d42a926_stylesFiles')) { function _lb0e6d42a926_stylesFiles($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block styles
//
if (!function_exists($_b->blocks['styles'][] = '_lba9be394073_styles')) { function _lba9be394073_styles($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
