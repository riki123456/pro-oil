<?php
// source: D:\!__robota\00__PHP\pro-oil.cz\App\Modules\Front/templates/Default/default.latte

class Template2598f04bdd7fdb65c52e120de711eaad extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('63582b5942', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block rightbar
//
if (!function_exists($_b->blocks['rightbar'][] = '_lb77c1792abb_rightbar')) { function _lb77c1792abb_rightbar($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbd4c901ea54_content')) { function _lbd4c901ea54_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div class="row">
