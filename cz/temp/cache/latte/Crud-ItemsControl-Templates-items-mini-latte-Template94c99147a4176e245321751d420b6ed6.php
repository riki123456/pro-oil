<?php
// source: /home/riki/work/www/pro-oil/App/Components/Controls/Crud/ItemsControl/Templates/items-mini.latte

class Template94c99147a4176e245321751d420b6ed6 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('302d26358d', 'html')
;
...
<?php } ?>
                    ...
                    <span class="product-price">
                        ...
                        <i>(vč. DPH <?php echo Latte\Runtime\Filters::escapeHtml(constant('DPH_PROCENTO'), ENT_NOQUOTES) ?>)</i> 
