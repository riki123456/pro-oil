<?php
// source: D:\!__robota\00__PHP\pro-oil.cz\App\Components\Controls\Crud\ItemsControl/Templates/item-detail.latte

class Template41a3df252e9df3bb961e86322119d345 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('514c65556e', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block _productsContainer
//
if (!function_exists($_b->blocks['_productsContainer'][] = '_lbd99d42abfb__productsContainer')) { function _lbd99d42abfb__productsContainer($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('productsContainer', FALSE)
;$_control->snippetMode = isset($_snippetMode) && $_snippetMode; $_itemNazevWebalize = \Nette\Utils\Strings::webalize($itemData->nazev) ?>
    <div class="row">
