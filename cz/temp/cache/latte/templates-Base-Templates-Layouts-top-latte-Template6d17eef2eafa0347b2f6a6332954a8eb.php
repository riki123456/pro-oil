<?php
// source: /home/riki/work/www/pro-oil/App/Modules/Front/templates/../../Base/Templates/Layouts/top.latte

class Template6d17eef2eafa0347b2f6a6332954a8eb extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('933b601f62', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block stylesFiles
//
if (!function_exists($_b->blocks['stylesFiles'][] = '_lb48ec1227a4_stylesFiles')) { function _lb48ec1227a4_stylesFiles($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block styles
//
if (!function_exists($_b->blocks['styles'][] = '_lb294c3240d0_styles')) { function _lb294c3240d0_styles($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
