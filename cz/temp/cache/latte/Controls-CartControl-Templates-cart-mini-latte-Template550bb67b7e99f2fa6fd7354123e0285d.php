<?php
// source: /home/riki/work/www/pro-oil/App/Components/Controls/CartControl/Templates/cart-mini.latte

class Template550bb67b7e99f2fa6fd7354123e0285d extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('4ee7f2773e', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block _cart-mini
//
if (!function_exists($_b->blocks['_cart-mini'][] = '_lba53ffb0d20__cart_mini')) { function _lba53ffb0d20__cart_mini($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('cart-mini', FALSE)
