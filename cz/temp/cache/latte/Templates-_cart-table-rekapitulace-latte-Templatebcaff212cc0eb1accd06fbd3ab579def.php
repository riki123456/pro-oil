<?php
// source: D:\!__robota\00__PHP\pro-oil.cz\App\Components\Controls\CartControl/Templates/_cart-table-rekapitulace.latte

class Templatebcaff212cc0eb1accd06fbd3ab579def extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('1d20fec556', 'html')
;
...
// main template
//
$cena_celkem_s_dph = 0 ;$cena_celkem_bez_dph = 0 ;$iterations = 0; foreach ($data as $d) { $cena_celkem_bez_dph = $cena_celkem_bez_dph + ($d->ora_pocet * $d->ora_cena_bez_dph) ;$iterations++; } ?>
