<?php
// source: /home/riki/work/www/pro-oil/App/Modules/Front/templates/Error/../../../Base/Templates/../../Base/Templates/Layouts/top.latte

class Template30e869f1dbf34a8aed1d7df431bfdfa6 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('65d85ccd0e', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block stylesFiles
//
if (!function_exists($_b->blocks['stylesFiles'][] = '_lbe713334739_stylesFiles')) { function _lbe713334739_stylesFiles($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block styles
//
if (!function_exists($_b->blocks['styles'][] = '_lb54b115e582_styles')) { function _lb54b115e582_styles($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
