<?php
// source: D:\!__robota\00__PHP\pro-oil.cz\App\Components\Controls\Crud/Templates/FormManually.latte

class Template3a9c46ac01a7e75fa3e3543f32c3299a extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('f1b9a56780', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block group
//
if (!function_exists($_b->blocks['group'][] = '_lbcb02fcecee_group')) { function _lbcb02fcecee_group($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block controls
//
if (!function_exists($_b->blocks['controls'][] = '_lb2825ac65d9_controls')) { function _lb2825ac65d9_controls($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block label
//
if (!function_exists($_b->blocks['label'][] = '_lba34312cbda_label')) { function _lba34312cbda_label($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block control
//
if (!function_exists($_b->blocks['control'][] = '_lb8a29ea11a1_control')) { function _lb8a29ea11a1_control($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>                        <div class="col-sm-9">
